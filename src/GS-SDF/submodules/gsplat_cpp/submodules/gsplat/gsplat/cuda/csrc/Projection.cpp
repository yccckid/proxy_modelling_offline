...
projection_ewa_3dgs_packed_fwd(
    ...
    if (C && N) {
        ...
        launch_projection_ewa_3dgs_packed_fwd_kernel(
            ...
            c10::nullopt, // depths
            c10::nullopt, // conics
            // pass in as an indicator on whether compensation will be applied
            // or not.
...
projection_2dgs_packed_fwd(
    ...
    at::Tensor randns = at::randn({nnz, 2}, means.options());
    at::Tensor samples = at::empty({nnz, 3}, means.options());
